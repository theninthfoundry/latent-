  ...
  return (
    <>
      ...
      >
        ...
        {/* Primary Navigation */}
        <div className="flex items-center gap-5 sm:gap-7 text-xs font-mono tracking-wider uppercase text-ink-light">
          {navLinks.map((link) => {
            const isActive =
              link.href === "/"
                ? pathname === "/"
          ...
          <div className="hidden lg:flex items-center gap-2 pl-3 border-l border-paper-border/80">
            <a
