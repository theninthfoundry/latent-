...
export function FieldNotes() {
  return (
    <section id="notes" className="relative pt-12 sm:pt-14 pb-14 sm:pb-16 px-6 sm:px-12 lg:px-20 max-w-[1500px] mx-auto border-t border-paper-border scroll-mt-24">
      {/* Header */}
